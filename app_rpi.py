...
class ImageAdDisplayWindow(QMainWindow):
    def __init__(self):
        ...
        self.mediaPlayer.setMedia(QMediaContent(
            QUrl.fromLocalFile("/home/pi/Desktop/Smart BMI/Img_SS.avi")))
...
class VideoAdDisplayWindow(QMainWindow):
    def __init__(self):
        ...
        self.index = 0
        self.flag = 0
        self.clips = glob.glob(R'/home/pi/Desktop/Smart BMI/Videos/*.avi')
...
class InsertWindow(QMainWindow):
    def __init__(self):
        # load ui
        super().__init__()
        uic.loadUi("/home/pi/Desktop/Smart BMI/UI Files/InsertWindow.ui", self)
...
class MainMenu(QMainWindow):
    def __init__(self):
        super().__init__()
        uic.loadUi("/home/pi/Desktop/Smart BMI/UI Files/MainMenuWindow.ui", self)
...
class SettingsOptions(QMainWindow):
    def __init__(self):
        super().__init__()
        uic.loadUi("/home/pi/Desktop/Smart BMI/UI Files/SettingsOptions.ui", self)
...
class SetupWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        uic.loadUi("/home/pi/Desktop/Smart BMI/UI Files/SetupWindow.ui", self)
...
class WCWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        uic.loadUi("/home/pi/Desktop/Smart BMI/UI Files/WeightCalibrationWindow.ui", self)
...
class HCWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        uic.loadUi("/home/pi/Desktop/Smart BMI/UI Files/HeightCalibrationWindow.ui", self)
...
class SMSCWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        uic.loadUi("/home/pi/Desktop/Smart BMI/UI Files/SMSConfigWindow.ui", self)
...
class RWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        uic.loadUi("/home/pi/Desktop/Smart BMI/UI Files/ReportWindow.ui", self)
...
class DiagWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        uic.loadUi("/home/pi/Desktop/Smart BMI/UI Files/DiagnosticsWindow.ui", self)
        self.Close_bt.clicked.connect(self.gotoSettingsOptions)
        # O/P on buttons
...
class PSSWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        uic.loadUi("/home/pi/Desktop/Smart BMI/UI Files/PrintSlipSettingsWindow.ui", self)
        self.list = []
...
class BMI(QMainWindow):
    def __init__(self):
        super().__init__()
        uic.loadUi("/home/pi/Desktop/Smart BMI/UI Files/BMIWindow.ui", self)
...
class POSWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        uic.loadUi("/home/pi/Desktop/Smart BMI/UI Files/PrintorSmsWindow.ui", self)
        self.secs = 10
...
class SendSMSWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        uic.loadUi("/home/pi/Desktop/Smart BMI/UI Files/SendSMSWindow.ui", self)
...
class GetDownAPWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        uic.loadUi("/home/pi/Desktop/Smart BMI/UI Files/GetDownAPWindow.ui", self)
        self.secs = 4
...
class GetDownWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        uic.loadUi("/home/pi/Desktop/Smart BMI/UI Files/GetDownWindow.ui", self)
        self.secs = 5
...
class NoPaperWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        uic.loadUi("/home/pi/Desktop/Smart BMI/UI Files/NoPaperWindow.ui", self)
...
class VirtualKeyboardWindow(QWidget):
    def __init__(self):
        super().__init__()
        uic.loadUi("/home/pi/Desktop/Smart BMI/UI Files/VirtualKeyboardWindow.ui", self)
        self.resize(600, 512)
...
class VirtualKeypadWindow(QWidget):
    def __init__(self):
        super().__init__()
        uic.loadUi("/home/pi/Desktop/Smart BMI/UI Files/VirtualKeypadWindow.ui", self)
        self.resize(600, 512)
        self.LE = QLineEdit()
...
class UI():
    def __init__(self):
        ...
        self.widget.setGeometry(0, 0, 600, 1024)
...
class GV():
    ...
    def getSettingsValues(self):
        self.SettingsInputs = QSettings('settings.ini',QSettings.IniFormat)
